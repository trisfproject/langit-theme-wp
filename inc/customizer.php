...
function langit_customizer_defaults() {
	return array(
		...
		'cta_title'                   => __( 'Ready to build a reliable building technology system?', 'langit' ),
		...
		'global_cta_title'            => __( 'Ready to build a reliable building technology system?', 'langit' ),
