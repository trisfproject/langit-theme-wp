...
function langit_customizer_defaults() {
	return array(
		...
		'client_logo_section_eyebrow' => __( 'Deployment Sectors', 'langit' ),
		'client_logo_section_title'   => __( 'Built for active operational environments.', 'langit' ),
		'client_logo_section_description' => __( 'Ruang lingkup penerapan mencakup fasilitas industri, gedung komersial, instansi, pendidikan, gudang, dan infrastruktur operasional.', 'langit' ),
		'featured_client_ids'         => '',
...
function langit_customize_register( $wp_customize ) {
	...
	$fields = array(
		...
		'show_client_logo_section' => array(
			'label'    => esc_html__( 'Show Deployment Sector Showcase', 'langit' ),
			'section'  => 'langit_homepage_sections',
			'type'     => 'checkbox',
			'sanitize' => 'langit_sanitize_checkbox',
		),
		...
		'client_logo_section_eyebrow' => array(
			'label'   => esc_html__( 'Sector Showcase Eyebrow', 'langit' ),
			'section' => 'langit_homepage_sections',
		),
		'client_logo_section_title' => array(
			'label'   => esc_html__( 'Sector Showcase Title', 'langit' ),
			'section' => 'langit_homepage_sections',
		),
		'client_logo_section_description' => array(
			'label'    => esc_html__( 'Sector Showcase Description', 'langit' ),
			'section'  => 'langit_homepage_sections',
			'type'     => 'textarea',
			'sanitize' => 'langit_sanitize_textarea',
		),
		'featured_client_ids' => array(
			'label'       => esc_html__( 'Featured Sector IDs', 'langit' ),
			'description' => esc_html__( 'Optional comma-separated sector post IDs. Order follows this list.', 'langit' ),
			'section'     => 'langit_homepage_sections',
			'sanitize'    => 'langit_sanitize_id_list',
		),
		'featured_client_count' => array(
			'label'    => esc_html__( 'Sector Item Limit', 'langit' ),
			'section'  => 'langit_homepage_sections',
			'type'     => 'number',
			'sanitize' => 'langit_sanitize_positive_int',
		),
