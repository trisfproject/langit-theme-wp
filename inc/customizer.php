...
function langit_customizer_defaults() {
	return array(
		...
		'partners_section_eyebrow'    => __( 'TEKNOLOGI YANG DIGUNAKAN', 'langit' ),
		'partners_section_title'      => __( 'Teknologi Terpercaya untuk Implementasi Sistem', 'langit' ),
		'partners_section_description' => __( 'PT Global Teknindo mengimplementasikan solusi menggunakan teknologi dan perangkat dari produsen terkemuka yang telah banyak digunakan pada berbagai proyek industri dan komersial.', 'langit' ),
		'industry_section_eyebrow'    => __( 'INDUSTRIES WE SERVE', 'langit' ),
		'industry_section_title'      => __( 'Technology solutions for operational facilities and enterprise environments.', 'langit' ),
		...
		'trust_section_eyebrow'       => __( 'WHY GLOBAL TEKNINDO', 'langit' ),
		'trust_section_title'         => __( 'Trusted technology implementation for modern facilities.', 'langit' ),
		...
		'trust_stat_1_value'          => '',
		'trust_stat_1_label'          => __( 'Industrial Projects', 'langit' ),
		'trust_stat_1_description'    => __( 'Supporting factories and operational facilities.', 'langit' ),
		'trust_stat_2_value'          => '',
		'trust_stat_2_label'          => __( 'Enterprise Clients', 'langit' ),
		'trust_stat_2_description'    => __( 'Serving companies across multiple industries.', 'langit' ),
		'trust_stat_3_value'          => '',
		'trust_stat_3_label'          => __( 'Technology Solutions', 'langit' ),
		'trust_stat_3_description'    => __( 'Integrated security, networking, electrical and safety systems.', 'langit' ),
		'trust_stat_4_value'          => '',
		'trust_stat_4_label'          => __( 'Technical Support', 'langit' ),
		'trust_stat_4_description'    => __( 'Responsive installation and maintenance services.', 'langit' ),
		...
		'client_logo_section_eyebrow' => __( 'Client References', 'langit' ),
		'client_logo_section_title'   => __( 'Trusted across industrial and facility environments.', 'langit' ),
		'client_logo_section_description' => __( 'Referensi pelanggan dari kawasan industri, fasilitas komersial, rumah sakit, apartemen, hotel, dan instansi berdasarkan dokumen company profile.', 'langit' ),
		'featured_client_ids'         => '',
...
function langit_customize_register( $wp_customize ) {
	...
	$fields = array(
		...
		'show_partners_section' => array(
			'label'    => esc_html__( 'Show Technology Partners', 'langit' ),
			'section'  => 'langit_homepage_sections',
			'type'     => 'checkbox',
			'sanitize' => 'langit_sanitize_checkbox',
		),
		'partners_section_eyebrow' => array(
			'label'    => esc_html__( 'Partners Eyebrow Text', 'langit' ),
			'section'  => 'langit_homepage_sections',
			'type'     => 'text',
		),
		'partners_section_title' => array(
			'label'    => esc_html__( 'Partners Section Headline', 'langit' ),
			'section'  => 'langit_homepage_sections',
			'type'     => 'text',
		),
		'partners_section_description' => array(
			'label'    => esc_html__( 'Partners Section Description', 'langit' ),
			'section'  => 'langit_homepage_sections',
			'type'     => 'textarea',
		),
		...
		'show_client_logo_section' => array(
			'label'    => esc_html__( 'Show Client Reference Showcase', 'langit' ),
			'section'  => 'langit_homepage_sections',
			'type'     => 'checkbox',
			'sanitize' => 'langit_sanitize_checkbox',
		),
		...
		'featured_client_ids' => array(
			...
			'description' => esc_html__( 'Optional comma-separated client reference post IDs. Order follows this list.', 'langit' ),
			'section'     => 'langit_homepage_sections',
			'sanitize'    => 'langit_sanitize_id_list',
		),
		'featured_client_count' => array(
			'label'    => esc_html__( 'Client Reference Item Limit', 'langit' ),
			'section'  => 'langit_homepage_sections',
			'type'     => 'number',
			'sanitize' => 'langit_sanitize_positive_int',
		),
